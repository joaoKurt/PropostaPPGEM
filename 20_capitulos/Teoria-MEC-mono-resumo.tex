...
O primerio MEC foi desenvolvido por \citeonline{Fuchs1959} na década de 1960. 
...
\citeonline{MillerR1998} compararam os modelos de Ambrazon-Sirignano e Bellan-Harstad e combinou-os em uma única representação matemática.
...
\citeonline{Sazhin2006} comparou o modelo Stefan-Fuchs (chamado de clássico) com o modelo de Abramzon-Sirignano e com correlações experimentais desenvolvidas para hidrocarbonetos alcanos.
...
\citeonline{SacomanoF2019IJHMT} comparou os modelos de AS e Miller usando a formulação de Miller1999 \todo{na situação ...}. 
