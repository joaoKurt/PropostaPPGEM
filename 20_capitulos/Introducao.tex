...
É conhecido que essa modelagem tem enorme influência na chama como um todo \source{Jenny}, influenciando a sua estrutura, temperatura, geometria e, por consequência, formação de poluentes também.
...
Sabe-se que a combustão de gota isolada é importante para a ignição do spray \source{AggarwalS2014}, mas não foram encontrados estudos sobre o seu impacto na estrutura da chama.
