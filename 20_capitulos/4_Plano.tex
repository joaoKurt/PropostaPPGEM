...
Em sequência virá o estudo aprofundado de modelos pre-existentes para a modelagem analítica de \yellow{de fenômenos de transporte no} interior de gota (tarefa \textbf{T3}), seguido pela avaliação da viabilidade de acoplamento de modelos monocomponente de combustão de gota isolada com discretização no interior da gota (tarefa \textbf{T4}).
