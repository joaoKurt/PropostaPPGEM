...
\end{align}
Esse modelo usa o chamado número de transporte de Spalding, introduzido por \source{Spalding}, que pode ser derivado da equação de temperatura ou de espécie, originando $B_T$ e $B_M$ (para igualdade, ver \source{Glassman2008}).
\begin{align}
