...
O modelo desenvolvido por Sacomano~et.~al em 2022 \cite{SacomanoF2022IJHMT} considera tanto a gota quanto os gases ambientes como multicomponentes, assim como a difusão diferencial das espécies e um comportamento de mistura não ideal.% e a condição de não equilíbrio termodinâmico na interface líquido-vapor.
...
Um modelo bem recebido é o modelo de Chiu e Liu \source{ChiuH1977, ChiuH1982}, que cria o parâmetro de combustão de grupo $G\propto N^{2/3}/S$, em que $N$ é o número de gotas e $S\propto l/D$ é o espaçamento médio normalizado pelo o diâmetro médio das gotas.
...
Diferentes modos de combustão de spray, incluindo a combustão de gota isolada, já foram observados em experimentos (e.g. \source{ChenG1996CF,CandelS1999,SinghG2020,ZhouH2024}) e em simulações DNS (e.g. \source{BorghesiG2013CF}) e LES (e.g.\source{Paulhiac}).
...
Por exemplo a revisão \source{ZhangY2023ECM} e os modelos \source{ZhouH2021,ZhouH2021CAF}. 
