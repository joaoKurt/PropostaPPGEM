...
Também é relevante a experiência do aluno com modelagem de transferência de calor e massa em gotas \source{HenningsJ2024MT}, o qual já tem familiaridade com os modelos monocomponente Stefan-Fuchs \cite{Glassman2008} e Abramzon-Sirignano \cite{Sirignano1989} e Godsave-Spalding \cite{Law1978}.
% Isso inclui compreender a derivação e as hipóteses 
% os modelos já encontrados 
...
\todo{Mencionar que é simulação 0D de evolução temporal.}
...
Os resultados obtidos desse empreendimento serão de grande valor científico. \question{Da pra tirar que informações?}
